...
| High | Secure private Drive records | Immediate | Critical security blocker | Canonical copies of the current legal/loan packet are in the existing numbered owner-only Drive record. The similarly named AIRBNB mirror reported `anyone with the link` writer access on 2026-08-08 and still contains legacy sensitive records. Remove that link permission, assess whether the link circulated, and verify file-level access before treating the archive as secure. |
| High | Prepare Queens publication package | 2026-06-03 | Done | Draft package is in `docs/business/publication/`. |
| High | Complete the New York publication process | 2026-10-01 | Partially complete / confirmation pending | Daily News payment and a reviewed notarized affidavit establish six weekly insertions on 2026-06-10, 06-17, 06-24, 07-01, 07-08, and 07-15. The Forum affidavit received 2026-08-10 supports six weekly publications from 2026-06-11 through 2026-07-16. The owner re-reviewed its handwritten commission-expiration date as an update to the older preprinted stamp date; publisher confirmation was requested 2026-08-14. The private Certificate of Publication draft remains unsigned pending that confirmation and final owner review. See `docs/business/publication/publication-completion-checklist.md` and `publication-activity-log.md`. |
| High | File Certificate of Publication | 2026-10-01 | Awaiting publisher confirmation and owner signature | After The Forum confirms the supplied affidavit, sign the private draft, attach both affidavits, include the $50 Department of State fee, retain tracking, and archive the filing receipt. |
...
| High | IRS EIN issued and CP 575 saved | 2026-06-03 | Done | EIN was issued on 2026-06-03. The CP 575 G letter and private EIN reference are in the existing owner-only Drive record. Do not copy the EIN value into Git or use the link-accessible AIRBNB mirror as the source. |
| High | Complete and submit NYS TR-570 response | Immediate | Fax transmitted / agency acknowledgment pending | The owner faxed the five-page response on 2026-08-11. The archived UPS transmission report shows the notice fax destination, `005/005`, and `Result OK`. Its machine clock printed an incorrect 2021 date, so retain the original image metadata and UPS context. The exact signed-and-dated transmitted packet has not been located separately; archive it if available and monitor for Tax Department follow-up. |
...
| High | Complete the G-101/G-102 legal transition to MLADIS | Before a DR operating, asset, revenue, or lender claim | Main packet delivered / counsel and family review pending | MLADIS was formed to place these two Dominican Republic vacation-rental operations under the company. On 2026-08-13, the AIRBNB repository and its four apartment submodules, accessible RIT/personal Drive records, and indexed RIT/personal Photos records from 2018-2026 were audited. The verified 68-page counsel package was delivered by private Drive link to counsel with Diana copied. The separate 18-page historical payment file remains withheld from counsel and is available on request. Diana received the main package, payment file, and private Photos album with direct mobile links; her validation and official payment histories for both units are pending. The MLADIS Google account was signed out and remains an explicit source-access gap. Obtain counsel acknowledgment; G-102 payoff/cancellation/current-title products and an accounting of work already paid for; current G-101 bank/title/legal-status records and applicable consents; RNC/Registro Mercantil and tax treatment; HOA confirmation; MITUR/RENATUR review; insurance; and the approved MLADIS ownership/operating structure. See `docs/business/dominican-republic-apartment-transition.md`. |
...
| Medium | Create funding-readiness tracker and data-room checklist | 2026-07-26 | Done | Public-safe trackers are in `docs/business/funding-readiness/`; the consolidated private legal/loan audit, current blank SBA forms, and unsigned borrowing resolution are in the existing owner-only Drive record. |
...
2. Preserve the received Forum affidavit as publication evidence. The owner re-reviewed its handwritten commission-expiration date as an update to the older preprinted stamp date; publisher confirmation was requested on 2026-08-14.
3. Retain the publisher's confirmation with the affidavit, then review both affidavits against the designation, entity name, schedule, notice, publisher signature, and jurat.
4. Review and sign the private Certificate of Publication draft after that confirmation and final owner review.
...
Current response status as of 2026-08-11:

- The owner faxed the five-page response. The UPS report shows `005/005` and
  `Result OK` to the notice fax destination; agency acknowledgment is pending.
- The fax report's machine date is incorrect, so retain the original image
  metadata and UPS context as part of the submission record.
- A separate copy of the exact signed-and-dated transmitted packet has not been
  located and should be archived if available.
- The fax-ready five-page response was prepared from the 2026-06-17 notice.
...
- The retained draft leaves signature/date blank; the transmitted copy was
  owner-signed and dated outside the draft workflow.
