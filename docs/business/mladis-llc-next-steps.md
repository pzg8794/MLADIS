...
| High | Complete the G-101/G-102 legal transition to MLADIS | Before a DR operating, asset, revenue, or lender claim | Verified counsel packet ready / delivery and official results pending | MLADIS was formed to place these two Dominican Republic vacation-rental operations under the company. On 2026-08-13, the AIRBNB repository and its four apartment submodules, accessible RIT/personal Drive records, and indexed RIT/personal Photos records from 2018-2026 were audited. A verified 89-page packet and private source/control records are stored owner-only and not yet sent. The MLADIS Google account was signed out and remains an explicit source-access gap. Send the packet in the existing counsel email thread and request receipt. Obtain G-102 payoff/cancellation/current-title products and an accounting of work already paid for; current G-101 bank/title/legal-status records and applicable consents; RNC/Registro Mercantil and tax treatment; HOA confirmation; MITUR/RENATUR review; insurance; and the approved MLADIS ownership/operating structure. See `docs/business/dominican-republic-apartment-transition.md`. |
