...
Use this after the Queens County Clerk assigns the designated newspapers.
...
- [x] Send publication designation request to Queens County Clerk at `QCC-LLC@nycourts.gov`.
  - Sent from the private MLADIS company mailbox on 2026-06-03 with `MLADIS_LLC-FilingReceipt-And-Articles.pdf` attached.
- [x] Save the County Clerk designation response/letter.
  - Letter received from `QCC-LLC@nycourts.gov` on 2026-06-08. Canonical copy is stored in the owner-only Drive record as `MLADIS_LLC-Publication-Designation-Letter-2026-06-08.pdf`.
...
- [x] Record designated weekly newspaper: **THE FORUM**. Phone: 718-845-3221. Email: forumsouth@gmail.com. Use the designation letter as the source for any physical-address detail.

## Step 2 - Place Notices

- [x] Send notice draft to **NY Daily News** via placeanad.nydailynews.com.
  - Order placed 2026-06-08. Order #87497, $235.00, Print+Online, invoiced run dates Jun 10–15 2026.
...
- [x] Obtain a compliant NY Daily News six-successive-weeks schedule.
  - The notarized affidavit received 2026-07-27 establishes weekly dates June 10, June 17, June 24, July 1, July 8, and July 15, 2026.
...
- [ ] Save filed Certificate of Publication confirmation.
- [ ] Verify the filing appears in the Department of State filing history.
- [ ] Order a fresh Certificate of Status for the lender packet.

Target filing deadline calculated from the 2026-06-03 formation date:
**2026-10-01**.
