...
- [Compliance tracker](compliance/README.md): repo-safe response plans for official post-formation information requests and similar administrative follow-ups.
...
- [EIN and banking package](ein-and-banking/README.md): completed EIN status, private CP 575 storage pointer, bank checklist, and bookkeeping starter categories.
