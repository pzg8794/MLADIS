...
| Item | Prepared support | Use |
| --- | --- | --- |
| B-1 process guide | `docs/business/immigration/b1-business-visitor-process.md` | Internal workflow before a specific visa renewal/application or trip |
| Invitation template | `docs/business/immigration/business-visitor-invitation-letter-template.md` | Copy for one specific trip after dates and agenda are known |
| Travel packet checklist | `docs/business/immigration/travel-packet-checklist.md` | Organize visit evidence around purpose, return intent, and trip costs |
| Private visa-history template | `docs/business/immigration/visa-history-review-private-template.md` | Fill outside Git before relying on a visitor strategy |

## Intentionally Deferred

| Area | Why deferred | Next MLADIS work |
| --- | --- | --- |
| Full bookkeeping integration | The owner has already started the system, and it should not be rebuilt as a throwaway workflow | Integrate into the MLADIS booking/accounting model after the OOP booking-system base is stable |
| Financial forecast and lender packet numbers | Needs revenue, expense, occupancy, and booking-system data | Use `docs/business/funding-readiness/metrics-and-financial-inputs.md` as the data contract |
...
1. Verify, fund if needed, and consistently use the approved Mercury business account.
