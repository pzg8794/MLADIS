# MLADIS Signing Packet - 2026-06-03
...
| --- | --- | --- |
| NYBE application confirmation | `docs/business/source-documents/MLADIS_LLC-Confirmation.pdf` | Archived |
| NYS DOS filing receipt and Articles of Organization | `docs/business/source-documents/MLADIS_LLC-FilingReceipt-And-Articles.pdf` | Archived |

## Do Not Sign Automatically

Do not apply, reuse, paste, or stamp a signature unless the owner explicitly approves the specific document in the current thread.
