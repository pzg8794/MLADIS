...
| DR counsel submission package | Corrected private packet prepared / counsel submission pending | A rebuilt, bookmarked packet and evidence-control log were verified in the owner-only Drive record on 2026-08-12. The earlier packet is marked superseded after a unit-evidence mapping error. The replacement separates G-101 and G-102, uses official ledgers and signed acquisition records, and excludes duplicate screenshots and unrelated correspondence. Current bank/registry documents and counsel's structure plan remain required. |
