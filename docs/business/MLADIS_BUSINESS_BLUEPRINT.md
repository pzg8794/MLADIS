...
| High | Complete the G-101/G-102 legal transition | Source records located / counsel intake pending | The operating objective is confirmed. Historical contracts, loan/closing records, powers, and 2020 title copies are present; previously documented binder/ZIP/draft filenames must be located or rebuilt. Obtain current titles and encumbrances, lender/Fiduciaria consent, lawful MLADIS title or operating authority, DR registration/tax/tourism review, HOA confirmation, insurance, and revenue-transition records before signing or making lender claims. |
| Medium | Build lender/grant/investor data room | In progress | Formation, EIN, governance, blank SBA forms, and 2024 pre-formation/personal Airbnb history are private. Mercury verification/statements, 2025 and 2026 exports, financials, insurance, publication closeout, and the G-101/G-102 legal-transition packet remain open. |
