...
MLADIS_LOCAL_DOMAIN="${MLADIS_LOCAL_DOMAIN:-127.0.0.1}"
MLADIS_PORT="${MLADIS_PORT:-8000}"
MLADIS_HOST="${MLADIS_HOST:-$MLADIS_LOCAL_DOMAIN}"
...
if truthy "$MLADIS_PUBLIC_TUNNEL"; then
  ...
  case "$MLADIS_TUNNEL_MODE" in
    named)
      export ALLOWED_HOSTS="${ALLOWED_HOSTS:-localhost,127.0.0.1,$MLADIS_LOCAL_DOMAIN,$MLADIS_LOCAL_PUBLIC_HOSTNAME}"
      export CSRF_TRUSTED_ORIGINS="${CSRF_TRUSTED_ORIGINS:-$MLADIS_LOCAL_PUBLIC_ORIGIN}"
      export SITE_DOMAIN="${SITE_DOMAIN:-$MLADIS_LOCAL_PUBLIC_HOSTNAME}"
      export SOCIAL_AUTH_GOOGLE_ORIGIN="${MLADIS_SOCIAL_AUTH_GOOGLE_ORIGIN:-${SOCIAL_AUTH_GOOGLE_ORIGIN:-$MLADIS_LOCAL_PUBLIC_ORIGIN}}"
      export SOCIAL_AUTH_GITHUB_ORIGIN="${MLADIS_SOCIAL_AUTH_GITHUB_ORIGIN:-${SOCIAL_AUTH_GITHUB_ORIGIN:-$MLADIS_LOCAL_PUBLIC_ORIGIN}}"
    ...
    quick)
      ...
      export SOCIAL_AUTH_GOOGLE_ORIGIN="${MLADIS_SOCIAL_AUTH_GOOGLE_ORIGIN:-${SOCIAL_AUTH_GOOGLE_ORIGIN:-$MLADIS_LOCAL_ORIGIN}}"
      export SOCIAL_AUTH_GITHUB_ORIGIN="${MLADIS_SOCIAL_AUTH_GITHUB_ORIGIN:-${SOCIAL_AUTH_GITHUB_ORIGIN:-$MLADIS_LOCAL_ORIGIN}}"
      export SOCIAL_AUTH_FACEBOOK_ORIGIN="${MLADIS_SOCIAL_AUTH_FACEBOOK_ORIGIN:-${SOCIAL_AUTH_FACEBOOK_ORIGIN:-}}"
      ;;
    *)
