# Generated by Django 5.2.13 on 2026-05-10 18:42
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(blank=True, choices=[('availability', 'Availability'), ('booking', 'Booking'), ('contact', 'Contact'), ('deposit', 'Deposit'), ('payment', 'Payment'), ('pricing', 'Pricing'), ('rules', 'Rules'), ('agent_scope', 'Agent scope'), ('general', 'General')], default='general', max_length=80)),
                ...
                ('min_score', models.DecimalField(decimal_places=2, default=Decimal('0.55'), max_digits=4)),
