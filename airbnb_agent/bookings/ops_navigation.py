...
OPS_NAV_ITEMS = [
    ...
    },
    {
        ...
        "href": "/ops/stays/",
        "icon": "stays",
        "description": "Listings, rooms, readiness",
        "tone": "#0f766e",
        "bg": "#ccfbf1",
        "shortcut_action": "Manage",
        "shortcut_tone": "blue",
    ...
    },
    {
        ...
        "href": "/ops/customers/",
        "icon": "customers",
        "description": "Profiles, consent, segments",
        "tone": "#16a34a",
        "bg": "#dcfce7",
        "shortcut_action": "View",
        "shortcut_tone": "violet",
    ...
    },
    {
        ...
        "href": "/ops/workboard/",
        "icon": "tasks",
        "description": "Assigned jobs and completion",
        "tone": "#d97706",
        "bg": "#fef3c7",
        "shortcut_action": "Open",
        "shortcut_tone": "violet",
        "badge": "12",
        "icon_svg": '<svg class="modern-admin-rail-icon" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="m3 17 2 2 4-4"/><path d="m3 7 2 2 4-4"/><path d="M13 6h8"/><path d="M13 12h8"/><path d="M13 18h8"/></svg>',
    },
    {
        "group": "Admin",
        "label": "Settings",
