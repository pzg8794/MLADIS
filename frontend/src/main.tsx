...
const isOps = isOpsDashboard || isOpsAdmin || isOpsReservations || isOpsReports || isOpsGuests || isOpsCustomers || isOpsDeposits || isOpsPayments || isOpsMaintenance || isOpsAgent || isOpsCalendar || isOpsSettings || isOpsWorkboard || isBusinessProfile;
