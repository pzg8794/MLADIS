...
const isOps = isOpsDashboard || isOpsAdmin || isOpsReservations || isOpsReports || isOpsCustomers || isOpsDeposits || isOpsPayments || isOpsMaintenance || isOpsAgent || isOpsCalendar || isOpsProperties || isOpsStays || isOpsSettings || isOpsWorkboard || isBusinessProfile;
