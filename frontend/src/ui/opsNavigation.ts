...
const fallbackOpsNavItems: RuntimeOpsNavItem[] = [
  { group: 'Overview', label: 'Dashboard', href: '/ops/dashboard/', icon: 'dashboard', description: 'Command overview and live metrics', tone: '#2563eb', bg: '#dbeafe', shortcutAction: 'Open', shortcutTone: 'blue' },
  ...
  { group: 'Operations', label: 'Stays', href: '/ops/stays/', icon: 'stays', description: 'Listings, rooms, readiness', tone: '#0f766e', bg: '#ccfbf1', shortcutAction: 'Manage', shortcutTone: 'blue' },
  ...
  { group: 'Operations', label: 'Agent Intelligence', href: '/ops/agent/', icon: 'agent', description: 'AI suggestions and training', tone: '#0d9488', bg: '#ccfbf1', shortcutAction: 'Manage', shortcutTone: 'rose' },
  { group: 'Business', label: 'Listings', href: '/ops/listings/', icon: 'listings', description: 'Properties and availability', tone: '#059669', bg: '#d1fae5', shortcutAction: 'Manage', shortcutTone: 'blue' },
  { group: 'Business', label: 'Customers', href: '/ops/customers/', icon: 'customers', description: 'Profiles, consent, segments', tone: '#16a34a', bg: '#dcfce7', shortcutAction: 'View', shortcutTone: 'violet' },
