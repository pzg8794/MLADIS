...
- The current Dropbox Sign upload package is `docs/business/signing/dropbox-sign-upload-2026-06-03/`; update its README and `docs/business/owner-action-center-2026-06-03.md` after every signing-state change.
- Use `docs/business/signing/polished-2026-06-03/` for the current branded signing files. If the docs are regenerated, use `docs/business/signing/scripts/generate_polished_signing_packet.py`, render the DOCX files to PDFs/page PNGs, inspect the rendered pages, and update the signing indexes before upload.
